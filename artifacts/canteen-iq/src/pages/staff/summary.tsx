...
import { Utensils, TrendingUp, Clock, FileWarning, IndianRupee, Package } from "lucide-react";
...
export default function StaffSummary() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-foreground mb-2">Daily Summary</h1>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        <Card className="glass-panel border-border">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-foreground">{summary.totalOrdersServed}</div>
        ...
        <Card className="glass-panel border-border">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-foreground truncate">{summary.mostOrderedItem || "N/A"}</div>
        ...
        <Card className="glass-panel border-border">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-foreground">₹{summary.totalRevenue.toFixed(2)}</div>
          </CardContent>
        </Card>
        ...
        <Card className="glass-panel border-border">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-foreground">{summary.busiestHour}</div>
          </CardContent>
        </Card>
        ...
        <Card className="glass-panel border-border">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-foreground">{summary.pendingOrders}</div>
        ...
        <Card className="glass-panel border-border">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-foreground">{summary.cancelledOrders}</div>
          </CardContent>
        </Card>
      </div>
    </div>
