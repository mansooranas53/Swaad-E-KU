...
export default function AuthPage() {
  ...
  return (
    <div className="flex min-h-screen bg-background text-foreground selection:bg-primary/30">
      <div className="hidden lg:flex w-1/2 relative bg-card flex-col items-center justify-center overflow-hidden border-r border-border">
        ...
        <div className="z-10 text-center max-w-md p-8">
          <div className="flex items-center justify-center gap-3 mb-6">
            ...
            <span className="text-3xl font-bold tracking-tight text-foreground">Swaad<span className="text-primary text-gradient">-E-KU</span></span>
          </div>
          <h1 className="text-4xl font-extrabold tracking-tight mb-4 text-foreground">Smart Canteen, Smarter Campus</h1>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 relative">
        ...
        <div className="w-full max-w-md glass-panel p-8 rounded-2xl relative z-10">
          <div className="lg:hidden flex items-center justify-center gap-3 mb-8">
            ...
            <span className="text-2xl font-bold tracking-tight text-foreground">Swaad<span className="text-primary">-E-KU</span></span>
          </div>

          <div className="flex items-center justify-center mb-8 bg-muted/60 p-1 rounded-lg border border-border">
            <button
              className={`flex-1 py-2 text-sm font-medium rounded-md transition-all ${isLogin ? "bg-card text-foreground shadow-sm" : "text-muted-foreground hover:text-foreground"}`}
            ...
            <Form {...loginForm}>
              <form onSubmit={loginForm.handleSubmit(onLoginSubmit)} className="space-y-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-foreground/80">College Email</FormLabel>
                      <FormControl>
                        <Input placeholder="student@college.edu" className="bg-muted/50 border-border focus-visible:ring-primary" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="password" placeholder="••••••••" className="bg-muted/50 border-border focus-visible:ring-primary" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Jane Doe" className="bg-muted/50 border-border focus-visible:ring-primary" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-foreground/80">College Email</FormLabel>
                      <FormControl>
                        <Input placeholder="jane@college.edu" className="bg-muted/50 border-border focus-visible:ring-primary" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                  ...
                  render={({ field }) => (
                    <FormItem className="space-y-3">
                      ...
                      <FormControl>
                        ...
                        >
                          <div className="flex items-center space-x-2 rounded-lg border border-border p-3 bg-muted/30 hover:bg-muted/60 transition-colors cursor-pointer">
                            <RadioGroupItem value="student" id="r1" className="border-primary text-primary" />
                            <Label htmlFor="r1" className="flex-1 cursor-pointer font-medium text-foreground/90">Student</Label>
                          </div>
                          <div className="flex items-center space-x-2 rounded-lg border border-border p-3 bg-muted/30 hover:bg-muted/60 transition-colors cursor-pointer">
                            <RadioGroupItem value="staff" id="r2" className="border-primary text-primary" />
                            <Label htmlFor="r2" className="flex-1 cursor-pointer font-medium text-foreground/90">Staff Member</Label>
                          </div>
                          <div className="flex items-center space-x-2 rounded-lg border border-border p-3 bg-muted/30 hover:bg-muted/60 transition-colors cursor-pointer">
                            <RadioGroupItem value="admin" id="r3" className="border-primary text-primary" />
                            <Label htmlFor="r3" className="flex-1 cursor-pointer font-medium text-foreground/90">Administrator</Label>
                          </div>
                        </RadioGroup>
                      </FormControl>
                      <FormMessage />
