...
import { DollarSign, Package, TrendingUp, AlertTriangle, Clock, TrendingDown } from "lucide-react";
    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        <Card className="glass-panel border-white/5">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-white">${summary.revenueToday.toFixed(2)}</div>
        ...
        <Card className="glass-panel border-white/5">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-white">{summary.totalOrdersToday}</div>
        ...
        <Card className="glass-panel border-white/5">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-white">{summary.wasteEstimate} kg</div>
            <p className="text-xs text-green-500 mt-1 flex items-center">
        ...
        <Card className="glass-panel border-white/5">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-white">{summary.peakHour}</div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card className="glass-panel border-white/5">
          <CardHeader>
            <CardTitle className="text-lg text-white">Top Selling Item</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="glass-panel border-white/5">
          <CardHeader>
            <CardTitle className="text-lg text-white">Live Operations</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              <div className="flex justify-between items-center">
                <span className="text-muted-foreground">Pending in Queue</span>
                <span className="font-bold text-white bg-white/10 px-2 py-1 rounded">{summary.pendingOrders}</span>
              </div>
              <div className="flex justify-between items-center">
